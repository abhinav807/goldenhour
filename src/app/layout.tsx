...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", locale: "en_IN", ...(siteUrl ? { url: siteUrl } : {}), siteName: "GOLDENHOUR", title: "GOLDENHOUR — Build Before Sunrise", description: baseDescription, images: [{ url: "/og-image.png", width: 286, height: 131, alt: "GOLDENHOUR wordmark logo" }] },
