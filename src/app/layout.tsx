...
export const metadata: Metadata = {
  ...
  title: { default: "GoldenHour — Build What's Next", template: "%s | GoldenHour" },
  ...
  openGraph: { type: "website", locale: "en_IN", ...(siteUrl ? { url: siteUrl } : {}), siteName: "GoldenHour", title: "GoldenHour — Build What's Next", description: baseDescription, images: [{ url: "/og-image.png", width: 286, height: 131, alt: "GoldenHour wordmark logo" }] },
  twitter: { card: "summary_large_image", title: "GoldenHour — Build What's Next", description: baseDescription, images: ["/og-image.png"] },
