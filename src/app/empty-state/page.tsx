...
export const metadata = pageMetadata("Community — Coming Soon", "The GOLDENHOUR community space is still being built. Return to the event site or contact the student collective.", "/empty-state");
