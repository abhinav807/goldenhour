...
export default function FinalCTA() {
  return <section id="register" className="bg-sunset py-24 md:py-36 px-5 md:px-12 relative overflow-hidden border-t-4 border-black">
    ...
    <div className="max-w-[980px] mx-auto relative z-10 reveal text-center">
      ...
      <p className="font-dm text-lg md:text-2xl text-black/70 max-w-2xl mx-auto leading-snug">Registration for GoldenHour V1 opens in November 2026. Check back then to reserve your place.</p>
      <div className="flex flex-col sm:flex-row gap-4 mt-10 justify-center"><span className="brutal-btn px-8 py-5 text-sm md:text-base cursor-default">REGISTRATION OPENS {eventConfig.registrationOpening}</span><a href={eventConfig.volunteerUrl} target="_blank" rel="noreferrer" className="brutal-btn-outline px-8 py-5 text-sm md:text-base">VOLUNTEER WITH US <ArrowRight size={18} /></a><a href={eventConfig.whatsappCommunityUrl} target="_blank" rel="noreferrer" className="brutal-btn-outline px-8 py-5 text-sm md:text-base">JOIN WHATSAPP COMMUNITY <ArrowRight size={18} /></a><a href="mailto:goldenhourdelhi@gmail.com" className="inline-flex items-center justify-center gap-2 font-space text-xs font-bold uppercase underline underline-offset-4 hover:no-underline">Questions? Email us <Mail size={15} /></a></div>
