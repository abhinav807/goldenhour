...
export default function FinalCTA() {
  return (
    <section
      id="register"
      className="bg-sunset py-28 md:py-40 px-5 md:px-12 relative overflow-hidden border-t-4 border-black"
    >
      {/* Decorative elements */}
      <div className="absolute top-10 left-10 w-20 h-20 border-2 border-black/20 rotate-45" />
      ...
      <div className="absolute bottom-10 right-24 w-12 h-12 border border-black/15 rounded-full" />
