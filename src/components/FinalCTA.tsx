  ...
  return (
    ...
    >
      ...
      <div className="max-w-[900px] mx-auto text-center relative z-10 reveal">
        ...
        <h2 className="font-archivo text-[14vw] md:text-[8vw] lg:text-[6vw] text-black leading-[0.85] mb-8">
          YOUR HOUR
          <br />
          STARTS NOW.
        </h2>
        ...
        <div className="flex flex-wrap justify-center gap-6 md:gap-10">
          ...
          <div className="text-center">
            ...
            <p className="font-space text-xs font-bold text-black">8 HOURS</p>
          </div>
          <div className="text-center">
            <p className="font-space text-[10px] text-black/40 uppercase font-bold">AGE</p>
            <p className="font-space text-xs font-bold text-black">UNDER 19</p>
          </div>
          <div className="text-center">
