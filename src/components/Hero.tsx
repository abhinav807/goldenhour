  ...
  return (
    <section id="hero" className="relative min-h-screen flex flex-col justify-center bg-black text-offwhite overflow-hidden px-5 md:px-10 hero-grid">
      ...
      <div className="relative z-10 w-full max-w-none mx-auto pt-32 pb-28 text-center flex flex-col items-center">
        ...
        <div className="mt-10 max-w-[700px] mx-auto flex flex-col items-center gap-8"><p className="font-dm text-lg md:text-2xl text-offwhite/70 max-w-lg leading-snug">A student-built technology experience for people who refuse to wait for the right moment.</p><div className="w-full flex flex-col sm:flex-row items-center justify-center gap-3"><a href="#register" className="brutal-btn-orange px-7 py-4 mx-auto sm:mx-0">ENTER GOLDENHOUR <ArrowRight size={16} /></a><a href="#events" className="brutal-btn-outline border-offwhite/40 text-offwhite px-7 py-4 hover:border-black mx-auto sm:mx-0">VIEW TRACKS</a></div></div>
